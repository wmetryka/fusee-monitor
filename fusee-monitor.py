...
# rewritten with ude of pyudev by @jestemkioskiem
...
for device in iter(monitor.poll, None):
    if(device.get('ID_VENDOR_ID') == "0955"): # Making sure it's the RCM switch
        print("Found RCM Switch!")
        try:
            main()
        except: # Catching everything into a try catch because it otherwise crashes due to pyusb error after injection.
            print("Finished running, rebooting!")
            pass
